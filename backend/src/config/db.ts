...
const pool = new Pool({
  ...
  user: process.env.DB_APP_USER || process.env.DB_USER || 'deploymate_app',
  password: process.env.DB_APP_PASSWORD || process.env.DB_PASSWORD || 'deploymate_app_password_dev',
